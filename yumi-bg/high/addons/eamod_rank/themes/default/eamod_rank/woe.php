...
?>
<h2>Cumulative Ranking War of Emperium</h2>
	<form method="post" id="mySelectClass" action="<?php echo $this->url('eamod_rank','woe'); ?>">
		<select name="opt" id="myClass" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
		...
		<select name="ser" id="myTypeSort" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
		...
		<select name="ord" id="mySort" style="font-family:Arial, Helvetica, sans-serif; font-size:12px;">
			<option value="0" <?php if($myTypeSort == "0") echo "selected"; ?>>Descending</option>
			<option value="1" <?php if($myTypeSort == "1") echo "selected"; ?>>Ascending</option>
		</select>
...
<table cellpadding="0" cellspacing="0" class="eAModRanking" style="border: 1px solid #FFC300;">
	<tr bgcolor="#A92207">
		<th style="width:20px; padding:3px;" rowspan="2">
			<img src="<?php echo $this->emblem($playerLadder->guild_id) ?>" />
		</th>
		<th align="left" style="padding:3px;"><font color="#FFFFFF" size="3"><b><?php echo $playerLadder->name; ?></font></th>
		<th align="right" style="width:100px; padding:3px;"><font color="#FFFFFF" size="3"><?php echo $count; ?></font></th>							
	</tr>
	<tr bgcolor="#A92207">
		<th align="left" style="padding:3px;"><font color="#FFC300"><?php echo $playerLadder->gname; ?></font></th>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0;">
				<tr>
					<td align="center" style="padding:0;" style="width:100px;">
						<img src="<?php echo $this->themePath('img/eamod/class/') . $playerLadder->sex . "/" . $playerLadder->class . ".gif" ?>"/><br />
						<?php if ($job=$this->jobClassText($playerLadder->class)): ?>
							<font size="2" color="#4169E1"><b><?php echo htmlspecialchars($job) ?></b></font>
						<?php else: ?>
							<span class="not-applicable">Unknown</span>
						<?php endif ?>
						<?php echo "<BR><font color='#FF0000' size='1'>" . $playerLadder->max_hp . " / " . $playerLadder->max_sp . "</font><BR><BR><BR>"; ?>
						<img src="<?php echo $this->themePath('img/eamod/rank/') . $result . ".png" ?>"/><br /><font size="1" color="#FFC300"><?php echo $Rank[$result] ?></font>
					</td>
					<td style="padding:0;">
						<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0;">
							<tr>
								<td style="padding:2px;">
									<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0;">
										<tr>
											<th colspan="6" style="color:#A92207; background-color:#FFC300">General Statistics</th>
										</tr>
										<tr>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('2733'); ?>" /></td>
											<td><strong>Score</strong><br /><?php echo $playerLadder->score; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('1214'); ?>" /></td>
											<td><strong>Kill</strong><br /><?php echo $playerLadder->kill_count; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('7005'); ?>" /></td>
								...
								<td style="padding:2px;">
									<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0;">
										<tr>
											<th colspan="6" style="color:#A92207; background-color:#FFC300">Damage VS Player</th>
										</tr>
										<tr>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('1819'); ?>" /></td>
											<td><strong>Score</strong><br /><?php echo $playerLadder->top_damage; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('1259'); ?>" /></td>
											<td><strong>Kill</strong><br /><?php echo $playerLadder->damage_done; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('2108'); ?>" /></td>
							...
							<tr>
								<td style="padding:2px;">
									<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0;">
										<tr>
											<th colspan="4" style="color:#A92207; background-color:#FFC300">Damage vs Estructures</th>
										</tr>
										<tr>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('714'); ?>" /></td>
											<td><strong>Emperium</strong><br /><?php echo $playerLadder->emperium_damage; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('1019'); ?>" /></td>
											<td><strong>Barricade</strong><br /><?php echo $playerLadder->barricade_damage; ?></td>
										</tr>
										<tr>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('7429'); ?>" /></td>
											<td><strong>G.Stone</strong><br /><?php echo $playerLadder->gstone_damage; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('1160'); ?>" /></td>
								...
								<td style="padding:2px;">
									<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0;">
										<tr>
											<th colspan="4" style="color:#A92207; background-color:#FFC300">Estructure Eliminated</th>
										</tr>
										<tr>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('714'); ?>" /></td>
							...
							<tr>
								<td style="padding:2px;">
									<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0;">
										<tr>
											<th colspan="4" style="color:#A92207; background-color:#FFC300">Skill Support</th>
										</tr>
										<tr>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('2277'); ?>" /></td>
											<td><strong>Correct</strong><br /><?php echo $playerLadder->support_skills_used; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('5203'); ?>" /></td>
								...
								<td style="padding:2px;">
									<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0;">
										<tr>
											<th colspan="4" style="color:#A92207; background-color:#FFC300">Total Healing</th>
										</tr>
										<tr>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('2277'); ?>" /></td>
							...
							<tr>
								<td style="padding:2px;" colspan="2">
									<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:0;">
										<tr>
											<th colspan="10" style="color:#A92207; background-color:#FFC300">Items Consumed</th>
										</tr>
										<tr>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('504'); ?>" /></td>
											<td><strong>HP</strong><br /><?php echo $playerLadder->hp_heal_potions; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('505'); ?>" /></td>
											<td><strong>SP</strong><br /><?php echo $playerLadder->sp_heal_potions; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('715'); ?>" /></td>
											<td><strong>Gems</strong><br /><?php echo $playerLadder->yellow_gemstones; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('716'); ?>" /></td>
											<td><strong>Gems</strong><br /><?php echo $playerLadder->red_gemstones; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('717'); ?>" /></td>
											<td><strong>Gems</strong><br /><?php echo $playerLadder->blue_gemstones; ?></td>
										</tr>
										<tr>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('676'); ?>" /></td>
											<td colspan="3"><strong>Total Zeny</strong><br /><?php echo $playerLadder->zeny_used; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('1752'); ?>" /></td>
											<td><strong>Arrow</strong><br /><?php echo $playerLadder->ammo_used; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('7136'); ?>" /></td>
											<td><strong>Bottle</strong><br /><?php echo $playerLadder->acid_demostration; ?></td>
											<td style="width:24px;"><img src="<?php echo $this->iconImage('678'); ?>" /></td>
