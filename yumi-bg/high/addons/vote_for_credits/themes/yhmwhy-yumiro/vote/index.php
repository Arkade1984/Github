...
<div class="generic-vote-div" style="float: left; margin: 0 0 10px 0; cursor: not-allowed" id="banner_<?php echo $banner->id ?>">
	<table class="yhmwhy-table" width="100%"> 
		<tr>
...
<?php foreach ($banners as $banner): ?>
	<div class="generic-vote-div" style="float: left; margin: 0 0 10px 0;" id="banner_<?php echo $banner->id ?>">
		<table class="yhmwhy-table" width="100%"> 
			<tr>
