...
return array(
	'ServerAddress'        => 'http://yumi-ro.com/',              // This value is the hostname:port under which Flux runs. (e.g., example.com or example.com:80)
	'BaseURI'              => '/high',                       // The base URI is the base web root on which your application lies.
	...
	'SiteTitle'            => 'Yumi Ragnarok Online - High Rate',     // This value is only used if the theme decides to use it.
	'ThemeName'            => 'yhmwhy-yumiro',                // The theme name of the theme you would like to use.  Themes are in FLUX_ROOT/themes.
