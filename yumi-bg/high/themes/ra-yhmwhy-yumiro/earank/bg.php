...
<div style="width:515px; overflow:auto;">
	...
	<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0">
		...
		<tr>
			...
			<th align="right" style="width:100px; padding:3px;"><?php echo playtime($playerLadder->playtime); ?></th>
		</tr>
		<tr>
			<td colspan="3">
				<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
					<tr>
						<td align="center" style="padding:0;" style="width:100px;" valign="top">
							...
							<a href="?module=earank&action=bprofile&cid=<?php echo $playerLadder->char_id; ?>"><img src="<?php echo $this->themePath('img/viewprofile.png')?>" /></a><BR><BR><BR>
							
							<img src="<?php echo $this->themePath('img/2733.png'); ?>"><br>
							Week Score<br>
								...
								<tr>
									<td style="padding:2px;">
										<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
											...
											<tr>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/7253.png'); ?>"/></td>
												<td><strong>Flags</strong><br /><?php echo $playerLadder->eos_flags; ?></td>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/7423.png'); ?>"/></td>
												<td><strong>Bases</strong><br /><?php echo $playerLadder->eos_bases; ?></td>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/658.png'); ?>"/></td>
								...
								<tr>
									<td style="padding:2px;" colspan="2">
										<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
											...
											<tr>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/750.png'); ?>"/></td>
												<td><strong>Boss Damage</strong><br /><?php echo $playerLadder->boss_damage; ?></td>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/751.png'); ?>"/></td>
								...
								<tr>
									<td style="padding:2px;" colspan="2">
										<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
											...
											<tr>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/640.png'); ?>"/></td>
									...
									<td style="padding:2px;" colspan="2">
										<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
											...
											<tr>
												...
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/1019.png'); ?>"/></td>
												<td><strong>Barricade</strong><br /><?php echo $playerLadder->barricade_kill; ?></td>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/7429.png'); ?>"/></td>
