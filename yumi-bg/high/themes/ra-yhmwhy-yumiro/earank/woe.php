				...
				<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
					<tr>
						<td align="center" style="padding:0;" style="width:100px;">
							...
							<a href="?module=earank&action=wprofile&cid=<?php echo $playerLadder->char_id; ?>"><img src="<?php echo $this->themePath('img/viewprofile.png')?>" /></a><BR><BR><BR>
							...
							<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
								<tr>
									<td style="padding:2px;">
										<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
											<tr>
												<th colspan="6" style="color:#FFFFFF; background-color:#f8a459">General Statistics</th>
											</tr>
											<tr>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/2733.gif'); ?>"/></td>
									...
									<td style="padding:2px;">
										<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
											<tr>
												<th colspan="6" style="color:#FFFFFF; background-color:#f8a459">Damage VS Player</th>
											</tr>
											<tr>
								...
								<tr>
									<td style="padding:2px;">
										<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
											<tr>
												<th colspan="4" style="color:#FFFFFF; background-color:#f8a459">Damage vs Estructures</th>
											</tr>
											<tr>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/714.gif'); ?>"/></td>
												<td><strong>Emperium</strong><br /><?php echo $playerLadder->emperium_damage; ?></td>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/1019.gif'); ?>"/></td>
												<td><strong>Barricade</strong><br /><?php echo $playerLadder->barricade_damage; ?></td>
											</tr>
											<tr>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/7429.gif'); ?>"/></td>
												<td><strong>G.Stone</strong><br /><?php echo $playerLadder->gstone_damage; ?></td>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/1160.gif'); ?>"/></td>
									...
									<td style="padding:2px;">
										<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
											<tr>
												<th colspan="4" style="color:#FFFFFF; background-color:#f8a459">Estructure Eliminated</th>
											</tr>
											<tr>
												<td style="width:24px;"><img src="<?php echo $this->themePath('img/714.gif'); ?>"/></td>
								...
								<tr>
									<td style="padding:2px;" colspan="2">
										<table width="100%" cellpadding="0" cellspacing="0" class="yhmwhy-table2" border="0" style="margin-bottom:0;">
											<tr>
												<th colspan="10" style="color:#FFFFFF; background-color:#f8a459">Items Consumed</th>
											</tr>
											<tr>
