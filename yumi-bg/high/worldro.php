<?php
	...
	$options = array (
		...
		'DBName'		=> 'highrate',
		'ServerName'	=> 'Yumi Ragnarok Private Server',
		'ServerURL'		=> 'http://www.yumi-ro.com/high'
	);
...
?>
	...
	<html>
		<head>
			...
			<title> <?php echo $options['ServerName']; ?> </title>
			<link href="style.css" rel="stylesheet" type="text/css" media="screen" title="" charset="utf-8" />
