...
return array(
	...
	'BaseURI'              => '/lowrate',                       // The base URI is the base web root on which your application lies.
	...
	'SiteTitle'            => 'Woe Yumi Ragnarok',     // This value is only used if the theme decides to use it.
	'ThemeName'            => 'cavalero',                // The theme name of the theme you would like to use.  Themes are in FLUX_ROOT/themes.
	...
	'MailerFromName'       => 'Cavalero Notification',             // The name displayed with the From e-mail address.
	...
	'PayPalBusinessEmail'  => 'neza_zane@yahoo.com',        // Enter the e-mail under which you have registered your business account.
	...
	// WoE Flags. Castle names.
	'CastleNames' => include('castlenames.php'),

	// Woe 1.0 Flags.
	'WoeFlags1' => include('woeflags1.php'),

	// Woe 2.0 Flags.
	'WoeFlags2' => include('woeflags2.php'),
	...
	// Vote for Cash Points links
	'VoteForPointsLinks' => array(
		array('Xtremetop100', 'http://www.xtremetop100.com/')
	)
);
?>
