...
<?php foreach ($accounts as $account): ?>
	<table class="yhmwhy-table" width="100%">
		<tr>
			...
			<th align="left" width="90">Username</th>
			<td width="90"><?php echo htmlspecialchars($account->userid) ?></td>
		</tr>
		<tr>
			...
			<th align="left">Credit Balance</th>
			<td><?php echo number_format((int)$account->balance) ?></td>
		</tr>
		<tr>
			<th align="left">Account Level</th>
			<td><?php echo (int)$account->level ?></td>

			<th align="left">Account State</th>
			<td>
