...
<table class="yhmwhy-table" width="100%">
	...
	<tr>
		<th>Emblem ID</th>
		<td><?php echo number_format($guild->emblem_id) ?>&nbsp;<img src="<?php echo $this->emblem($guild->guild_id) ?>" /></td>
	...
	<tr>
		<th>Average Level</th>
		<td><?php echo number_format($guild->average_lv) ?></td>
		<th>Skill Point</th>
...
<?php else: ?>
<h3>No such guild was found. <a href="javascript:history.go(-1)">Go back</a>.</h3>
<?php endif ?>