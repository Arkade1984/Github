...
function ShowDonate(){
	location.href = 'index.php?module=pages&action=content&path=donate';
}

function ShowStaff(){
	location.href = 'index.php?module=pages&action=content&path=staff';
}

function ShowServerinfo(){
	location.href = 'index.php?module=pages&action=content&path=serverinfo';
}

function ShowRules(){
	location.href = 'index.php?module=pages&action=content&path=rules';
}

function ShowForum(){
	window.open('http://yumi-ro.com/forum');
}


function SelectSearch(what){
	if(what == 1){
		document.getElementById('MobName').style.backgroundPosition='bottom center';
		document.getElementById('ItemName').style.backgroundPosition='top center';
		document.getElementById('module').value = 'monster';
	}else{
		document.getElementById('ItemName').style.backgroundPosition='bottom center';
		document.getElementById('MobName').style.backgroundPosition='top center';
