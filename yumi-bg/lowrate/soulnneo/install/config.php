...
$CONFIG['rag_pass']		=	'maazfaith786';		// SQL Ragnarok Password
$CONFIG['rag_db']			=	'soulnneo';		// SQL Ragnarok Database name
$CONFIG['log_db']			=	'log';		// SQL Ragnarok Log Database name

$CONFIG['cp_serv']		=	'localhost';	// SQL CP Host
$CONFIG['cp_user']		=	'root';		// SQL CP User
$CONFIG['cp_pass']		=	'maazfaith786';		// SQL CP Password
$CONFIG['cp_db']			=	'ceressoul';			// SQL CP Database name
...
//server name, rates
$CONFIG['name']			=	'Cavalero Control Panel';	// name of the server
...
$CONFIG['dynamic_name']		=	'Cavalero Control Panel';	// The name of the server in ragsrvinfo's server name column (Used for dynamic info)
...
$CONFIG['accport']		=	'6902';		// Account/Login Server Port
$CONFIG['charip']			=	'127.0.0.1';	// Char Server IP
$CONFIG['charport']		=	'7123';		// Char Server Port
$CONFIG['mapip']			=	'127.0.0.1';	// Zone/Map Server IP
$CONFIG['mapport']		=	'8123';		// Zone/Map Server Port
