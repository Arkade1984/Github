...
<?php foreach ($accounts as $account): ?>
	<table class="yhmwhy-table" width="100%">
		...
		<tr>
			<th align="left" width="100">Gender</th>
			<td>
			...
			<th align="left" width="100">Credit Balance</th>
			<td><?php echo number_format((int)$account->balance) ?></td>
		</tr>
		<tr>
			<th align="left" width="100">Account Level</th>
			<td><?php echo (int)$account->level ?></td>

			<th align="left" width="100">Account State</th>
			<td>
		...
		<tr>
			...
			<th align="left" width="100">Login Count</th>
			<td><?php echo number_format((int)$account->logincount) ?></td>
		</tr>
		<tr>
			<th align="left" width="100">Last Login Date</th>
			<td>
			...
			<th align="left" width="100">Last Used IP</th>
			<td>
		...
		<?php if ($showPassword): ?>
			<tr>		
				...
				<td colspan="3"><?php echo htmlspecialchars($account->user_pass) ?></td>
			</tr>
		<?php endif ?>
	</table>
<?php endforeach ?>
