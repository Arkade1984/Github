...
<span class="myTitle">Viewing Monster<br /><br /></span>
...
<table class="yhmwhy-table" style="width:100%" cellspacing="0">
	<tr>
		<th>Monster ID</th>
	...
	<tr>
        ...
        <?php if ($itemDrops): ?>
			<br><br>
           <span class="myTitle"><?php echo htmlspecialchars($monster->iro_name) ?> Item Drops<br /><br /></span>
            <table class="yhmwhy-table" style="width:100%">
                <tr>
                    <th>Item ID</th>
...
<br><br>
<span class="myTitle">Monster Skills for “<?php echo htmlspecialchars($monster->iro_name) ?>?<br /><br /></span>


<?php if (!filesize($skillDB)): ?>
	<span  class="myText"><strong>Mob skill database needs to be reloaded!</strong></span>
<?php elseif (empty($skillDB)): ?>
	<span  class="myText">No skills found for <?php echo htmlspecialchars($monster->iro_name) ?>.<span  class="myText">
<?php else: ?>
