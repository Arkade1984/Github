...
<h2>Death Ranking</h2>
<h3>
	Top <?php echo number_format($limit=(int)Flux::config('CharRankingLimit')) ?> Most Unlucky Characters
...
<form action="" method="get" class="search-form2">
	<?php echo $this->moduleActionFormInputs('pvp', 'deaths') ?>
	<p>
...
<table class="horizontal-table">
	...
	<tr>
		...
		<td><?php echo number_format((int)$chars[$i]->deaths) ?></td>
