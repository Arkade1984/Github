...
<h2>PVP Ranking</h2>
<h3>
	Top <?php echo number_format($limit=(int)Flux::config('CharRankingLimit')) ?> Most Vicious Characters
...
<form action="" method="get" class="search-form2">
	<?php echo $this->moduleActionFormInputs('pvp', 'ranking') ?>
	<p>
...
<table class="horizontal-table">
	...
	<tr>
		...
		<td><?php echo number_format((int)$chars[$i]->kills / (int)$chars[$i]->deaths, 2) ?></td>
