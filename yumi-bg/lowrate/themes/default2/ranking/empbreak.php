...
<h2>Emperium Break Ranking</h2>
<h3>
	Top <?php echo number_format($limit=(int)Flux::config('CharRankingLimit')) ?> Most Hax Characters
...
<form action="" method="get" class="search-form2">
	<?php echo $this->moduleActionFormInputs('ranking', 'empbreak') ?>
	<p>
...
<table class="horizontal-table">
	...
	<tr>
		...
		<td><?php echo number_format((int)$chars[$i]->empbreak) ?></td>
