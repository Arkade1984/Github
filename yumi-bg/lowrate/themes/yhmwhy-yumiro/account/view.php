...
<?php foreach ($characters as $serverName => $chars): $zeny = 0; ?>
	...
	<?php if ($chars): ?>
		<?php foreach ($chars as $char): $zeny += $char->zeny; ?>
			<table class="yhmwhy-table" width="100%">
				<tr>
					<th style="width:100px;"><?php echo htmlspecialchars(Flux::message('AccountViewSlotLabel')) ?></th>
					<td style="width:100px;"><?php echo $char->char_num+1 ?></td>

					<th style="width:60px;"><?php echo htmlspecialchars(Flux::message('AccountViewJlvlLabel')) ?></th>
				...
				<tr>
					...
					<th><?php echo htmlspecialchars(Flux::message('AccountViewGuildLabel')) ?></th>
					<td>
