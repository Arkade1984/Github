...
<?php if ($castle): ?>
<div class="CastleMid">
	<div class="CastleHead" style="min-height:500px;" >
    	<div class="FlagContainer">
		<?php 
			foreach ($castleflag as $castleflag):
			$castlename = getCastleName($castleflag->castle_id);
			?>
            <div class="Flag">
            	<div class="FlagEmblem">
                	<?php if ($castleflag->guild_emblem_len): ?><img src="<?php echo $this->emblem($castleflag->guild_id) ?>" width="50" height="50" title="<strong>Castle:</strong> <?php echo $castlename; ?><br><strong>Guild:</strong> <?php echo htmlspecialchars(basename($castleflag->name)); ?><br><strong>GL:</strong> <?php echo htmlspecialchars(basename($castleflag->master)); ?>" /><?php endif ?>
				</div>
			</div>
		<?php endforeach ?>        
        </div>
	...
	<table class="yhmwhy-table" cellspacing="3" cellpadding="2" width="100%" style="border:1px solid #adad66;">
		...
		<?php $ctr=1; $ctr2 = 0;
			...
			<tr>
				...
				<td align="center"><?php echo htmlspecialchars(basename($castle->economy)) ?></td>
				<td align="center"><?php echo htmlspecialchars(basename($castle->defense)) ?></td>
			</tr>
		<?php endforeach ?>
	</table>
<?php else: ?>
