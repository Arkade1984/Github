	...
	<div id="motioncontainer">
		...
		<div id="motiongallery" style="position:absolute;left:0;;top:0;white-space: nowrap;">
			<nobr id="trueContainer">
				<img src="<?php echo $this->themePath('img/ItemMall/redvalkhelm.png') ?>" title="Red Valkyrie Helm<br>$100">
				<img src="<?php echo $this->themePath('img/ItemMall/redvalkhelm.png') ?>" title="Red Valkyrie Helm<br>$100">
				<img src="<?php echo $this->themePath('img/ItemMall/redvalkhelm.png') ?>" title="Red Valkyrie Helm<br>$100">
				<img src="<?php echo $this->themePath('img/ItemMall/redvalkhelm.png') ?>" title="Red Valkyrie Helm<br>$100">
				<img src="<?php echo $this->themePath('img/ItemMall/redvalkhelm.png') ?>" title="Red Valkyrie Helm<br>$100">
	...
	<div class="News">
		<?php if ($News): ?>
			<?php foreach ($News as $News): ?>
				<div class="myNews">
					<div class="NewsTitle"><a href="<?php echo $News->news_body; ?>" target="_blank"><?php echo $News->news_title; ?></a></div>
					<div class="NewsDate"><?php echo date("M-d-Y", strtotime($News->news_dateposted)); ?></div>
					<div class="NewsAuthor">Posted by: <?php echo $News->news_author; ?></div>
				</div>
			<?php endforeach;?>
		<?php endif ?>
		<!--<div class="myNews">
			<div class="NewsTitle">Lorem ipsum Dolor sit amet</div>
			<div class="NewsDate">10/20/2011</div>
			<div class="NewsAuthor">Posted by: wtfitslekzen</div>
		</div>
		<div class="myNews">
			<div class="NewsTitle">Lorem ipsum Dolor sit amet</div>
			<div class="NewsDate">10/20/2011</div>
